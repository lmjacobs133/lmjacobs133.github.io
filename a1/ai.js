...
function guessCity() {
var state;
var cities = document.getElementById("userInput").value;
    
// Array of cities where I have lived when State is input
var citiesarray1 = ["Cheektowaga, Rochester, and Kenmore", "Crofton", "Tampa and Wesley Chapel", "That is not a State I have lived in.  Try either NY, MD, or FL!"]
...
function yearsCity(index) {    
    ...
    var citiesarray2 = ["Cheektowaga, NY", "Rochester, NY", "Kenmore, NY", "Crofton, MD", "Tampa, FL", "Wesley Chapel, FL"]
    document.getElementById("city").innerHTML = citiesarray2[index];
    
}

function bfloPopup() {
	var win = window.open("", "Title", "toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=600, height=350");
